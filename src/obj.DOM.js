var Obj = {
		...
		DOM : function(ob, add, type, list ) {
			...
			if (!this.isElement( this.$('Objtxt') ) ) {
				...
				var ObjInput = this.createElement( 'input',
					{ value : ObjInputValue, id : 'ObjInput'},
					{ width : '370px', height : '25px', position : 'fixed', top : '0', left : '1px', border : '2px solid green', padding: '0px', boxSizing : 'content-box' },
					document.body,
				...
				var ObjSend = this.createElement( 'input',
					{ type : 'button', value : '>>', id : 'ObjSend'},
					{ width : '30px', height : '25px', position : 'fixed', top : '0', border : '2px solid green', left : ObjInput.offsetWidth + 'px', padding: '0px', boxSizing : 'content-box' },
					document.body,
					document.body.children[0]
				);
				...
				this.createElement( 'textarea',
					{ id : 'Objtxt'},
					{ width : '400px', height : '400px', position : 'fixed', fontSize : '11px', top :ObjInput.offsetHeight + 'px', left : '1px', border:'2px solid green', padding: '0px', boxSizing : 'content-box'},
					document.body,
					document.body.children[0]
				);
	...
	function PA ( exp, text ) {
		console.assert( exp, text||'' )
	}
	
	
	
	var LS = {
		data:{}, //Хранилище переменных
